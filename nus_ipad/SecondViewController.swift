...
class SecondViewController: UIViewController,AVAudioRecorderDelegate {
    ...
    lazy var iFlySpeechRecognizer: IFlySpeechRecognizer = {
        ...
        //设置最长录音时间:60秒
        iFlySpeechRecognizer.setParameter("600000", forKey: IFlySpeechConstant.speech_TIMEOUT())
    ...
    override func viewDidLoad() {
        ...
        let instructlabel = UILabel(frame:CGRect(x:20, y:UIScreen.main.bounds.height-200, width:600, height:100))
         ...
         instructlabel.text = "Are you ready? Begin when you see the letter on the screen. The first letter is F ."
...
extension SecondViewController: IFlySpeechRecognizerDelegate {
    ...
    func request() {
        ...
        temp.removeFirst()
        let dict = ["code":"1-F","data": temp.components(separatedBy: ",")] as [String : Any]
