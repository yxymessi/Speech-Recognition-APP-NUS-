...
class FifthViewController: UIViewController,AVAudioRecorderDelegate {
    ...
    override func viewDidLoad() {
        ...
        instructlabel.text = "Instruction: Now, say out loud as many animals as you can. Name them as quickly as possible. Start now."
...
extension FifthViewController: IFlySpeechRecognizerDelegate {
    ...
    func request() {
        ...
        temp.removeFirst()
        let dict = ["code":"2-A","data": temp.components(separatedBy: ",")] as [String : Any]
