...
class FourthViewController: UIViewController,AVAudioRecorderDelegate  {
    //不带界面的识别对象
    ...
    override func viewDidLoad() {
        ...
        instructlabel.text = "Great! The first letter is A ."
...
extension FourthViewController: IFlySpeechRecognizerDelegate {
    ...
    func request() {
        ...
        temp.removeFirst()
        let dict = ["code":"1-A","data": temp.components(separatedBy: ",")] as [String : Any]
