...
class SixthViewController: UIViewController,AVAudioRecorderDelegate {
    //不带界面的识别对象
    ...
    override func viewDidLoad() {
        ...
        instructlabel.text = "Instruction: Now, say out loud as many vegetables as you can. Name them as quickly as possible. Start now."
...
extension SixthViewController: IFlySpeechRecognizerDelegate {
    ...
    func request() {
        ...
        temp.removeFirst()
        let dict = ["code":"2-V","data": temp.components(separatedBy: ",")] as [String : Any]
